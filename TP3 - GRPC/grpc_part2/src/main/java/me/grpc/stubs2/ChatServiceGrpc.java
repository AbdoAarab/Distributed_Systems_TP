...
public final class ChatServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<me.grpc.stubs2.Serverchat.ChatMessage,
      me.grpc.stubs2.Serverchat.ChatMessageFromServer> getSendChatMessageMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SendChatMessage",
      requestType = me.grpc.stubs2.Serverchat.ChatMessage.class,
      responseType = me.grpc.stubs2.Serverchat.ChatMessageFromServer.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<me.grpc.stubs2.Serverchat.ChatMessage,
      me.grpc.stubs2.Serverchat.ChatMessageFromServer> getSendChatMessageMethod() {
    io.grpc.MethodDescriptor<me.grpc.stubs2.Serverchat.ChatMessage, me.grpc.stubs2.Serverchat.ChatMessageFromServer> getSendChatMessageMethod;
      ...
      synchronized (ChatServiceGrpc.class) {
        if ((getSendChatMessageMethod = ChatServiceGrpc.getSendChatMessageMethod) == null) {
          ChatServiceGrpc.getSendChatMessageMethod = getSendChatMessageMethod = 
              io.grpc.MethodDescriptor.<me.grpc.stubs2.Serverchat.ChatMessage, me.grpc.stubs2.Serverchat.ChatMessageFromServer>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "ChatService", "SendChatMessage"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  me.grpc.stubs2.Serverchat.ChatMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  me.grpc.stubs2.Serverchat.ChatMessageFromServer.getDefaultInstance()))
  ...
  public static abstract class ChatServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<me.grpc.stubs2.Serverchat.ChatMessage> sendChatMessage(
        io.grpc.stub.StreamObserver<me.grpc.stubs2.Serverchat.ChatMessageFromServer> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                me.grpc.stubs2.Serverchat.ChatMessage,
                me.grpc.stubs2.Serverchat.ChatMessageFromServer>(
  ...
  private static abstract class ChatServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return me.grpc.stubs2.Serverchat.getDescriptor();
    }
